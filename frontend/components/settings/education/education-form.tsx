...
export function EducationForm({ initialData, onSave, onCancel }: EducationFormProps) {
    ...
    const degrees = [
        "High School", "Intermediate", "Bachelor of Technology (BTech)", "Associate Degree", "Bachelor of Arts(BA)", "Bachelor of Science (BS)", "Bachelor of Engineering (BE)", "Bachelor of Computer Application(BCA)", "Bachelor of Business Administration(BBA)", "Bachelor of Commerce(BCom)", "Bachelor of Fine Arts(BFA)", "Bachelor of Medicine(MBBS)", "Bachelor of Dental Surgery(BDS)", "Bachelor of Pharmacy(BPharm)", "Bachelor of Architecture(BArch)", "Bachelor of Laws(LLB)","Bachelor of Education (BEd)", "Bachelor of Social Work (BSW)","Bachelor of Journalism","Bachelor of Design","Graduation","Certificate","Diploma","Advanced Diploma","Professional Certificate","Trade Certificate","Vocational Training","Master of Arts(MA)","Master of Science(MSC)","Master of Technology(MTech)","Master of Engineering(ME)","Master of Computer Application (MCA)","Master of Business Administration (MBA)","Master of Commerce(MCom)","Master of Fine Arts(MFA)","Master of Medicine(MD)","Master of Dental Surgery(MDS)","Master of Pharmacy(MPharm)","Master of Architecture(MArch)","Master of Laws(LLM)","Master of Education(MEd)","Master of Social Work(MSW)","Master of Public Health(MPH)","Master of Public Administration(MPA)","Master of Library Science(MLS)","Master of Information Technology(MIT)","Master in Management(MIM)","Post Graduation","Doctor of Philosophy(PhD)","Doctor of Medicine(MD)","Doctor of Dental Medicine(DMD)","Doctor of Pharmacy(PharmD)","Doctor of Psychology(PsyD)","Doctor of Education(EdD)","Doctor of Business Administration(DBA)","Doctor of Judicial Science(SJD)","Doctor Of Engineering(EngD)","Doctor of Science(DSc)","Doctor of Letters(DLitt)","Juris Doctor(JD)","Master of Divinity(MDiv)","Master of Theology(ThM)","Doctor of Divinity(DD)","Chartered Accountant(CA)","Company Secretary(CS)","Cast and Management Accountant(CMA)","Postgraduate Diploma","Postgraduate Certificate","Executive Certificate","Professional Development Certificate","Online Degree","Distance Learning Degree","Correspondance Course","International Baccalaureate (IB)","A levels","O levels","Cambridge Certificate","GCSE","Fellowship","Residency","Internship Program","Apprenticeship","Boot Camp Certificate","Coding Boot Camp","Data Sciene Certificate","Digital Marketing Certificate","Project Management Certificate","Other"
    ]
